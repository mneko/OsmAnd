...
public class RouteColorize {
    ...
    public static final double[][] SLOPE_PALETTE = {{SLOPE_MIN_VALUE, GREEN_SLOPE}, {0.0, WHITE}, {(SLOPE_MAX_VALUE/8), YELLOW_SLOPE}, {(SLOPE_MAX_VALUE/4), RED_SLOPE}, {SLOPE_MAX_VALUE, PURPLE_SLOPE}};
